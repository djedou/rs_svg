...
use std::rc::Rc;
use super::path_attributes::PathProps;
...
impl Component for SvgPath {
    ...
    fn view(&self) -> Html {
        ...
        let mut path_tag = html! {<path />};

        set_attribute(self.d.as_ref(), &mut path_tag, "d");
        set_attribute(self.path_length.as_ref(), &mut path_tag, "pathLength");

        set_attribute(self.id.as_ref(), &mut path_tag, "id");
        set_attribute(self.tabindex.as_ref(), &mut path_tag, "tabindex");

        set_attribute(self.style.as_ref(), &mut path_tag, "style");
        set_attribute(self.class.as_ref(), &mut path_tag, "class");

        set_attribute(self.clip_path.as_ref(), &mut path_tag, "clip-path");
        set_attribute(self.clip_rule.as_ref(), &mut path_tag, "clip-rule");

        set_attribute(self.color.as_ref(), &mut path_tag, "color");
        set_attribute(self.color_interpolation.as_ref(), &mut path_tag, "color-interpolation");
        set_attribute(self.color_rendering.as_ref(), &mut path_tag, "color-rendering");

        set_attribute(self.cursor.as_ref(), &mut path_tag, "cursor");
        set_attribute(self.display.as_ref(), &mut path_tag, "display");

        set_attribute(self.fill.as_ref(), &mut path_tag, "fill");
        set_attribute(self.fill_opacity.as_ref(), &mut path_tag, "fill-opacity");
        set_attribute(self.fill_rule.as_ref(), &mut path_tag, "fill-rule");

        set_attribute(self.filter.as_ref(), &mut path_tag, "filter");
        set_attribute(self.mask.as_ref(), &mut path_tag, "mask");
        set_attribute(self.opacity.as_ref(), &mut path_tag, "opacity");
        set_attribute(self.pointer_events.as_ref(), &mut path_tag, "pointer-events");
        set_attribute(self.shape_rendering.as_ref(), &mut path_tag, "shape-rendering");
        
        set_attribute(self.stroke.as_ref(), &mut path_tag, "stroke");
        set_attribute(self.stroke_dasharray.as_ref(), &mut path_tag, "stroke-dasharray");
        set_attribute(self.stroke_dashoffset.as_ref(), &mut path_tag, "stroke-dashoffset");
        set_attribute(self.stroke_linecap.as_ref(), &mut path_tag, "stroke-linecap");
        set_attribute(self.stroke_linejoin.as_ref(), &mut path_tag, "stroke-linejoin");
        set_attribute(self.stroke_miterlimit.as_ref(), &mut path_tag, "stroke-miterlimit");
        set_attribute(self.stroke_opacity.as_ref(), &mut path_tag, "stroke-opacity");
        set_attribute(self.stroke_width.as_ref(), &mut path_tag, "stroke-width");

        set_attribute(self.transform.as_ref(), &mut path_tag, "transform");
        set_attribute(self.vector_effect.as_ref(), &mut path_tag, "vector-effect");
        set_attribute(self.visibility.as_ref(), &mut path_tag, "visibility");

        set_attribute(self.aria_activedescendant.as_ref(), &mut path_tag, "aria-activedescendant");
        set_attribute(self.aria_atomic.as_ref(), &mut path_tag, "aria-atomic");
        set_attribute(self.aria_autocomplete.as_ref(), &mut path_tag, "aria-autocomplete");
        set_attribute(self.aria_busy.as_ref(), &mut path_tag,"aria-busy");
        set_attribute(self.aria_checked .as_ref(), &mut path_tag, "aria-checked");
        set_attribute(self.aria_colcount.as_ref(), &mut path_tag, "aria-colcount");
        set_attribute(self.aria_colindex.as_ref(), &mut path_tag, "aria-colindex");
        set_attribute(self.aria_colspan .as_ref(), &mut path_tag, "aria-colspan");
        set_attribute(self.aria_controls .as_ref(), &mut path_tag, "aria-controls");
        set_attribute(self.aria_current .as_ref(), &mut path_tag, "aria-current");
        set_attribute(self.aria_describedby.as_ref(), &mut path_tag, "aria_-escribedby");
        set_attribute(self.aria_details.as_ref(), &mut path_tag, "aria-details");
        set_attribute(self.aria_disabled.as_ref(), &mut path_tag, "aria-disabled");
        set_attribute(self.aria_dropeffect.as_ref(), &mut path_tag, "aria-dropeffect");
        set_attribute(self.aria_errormessage.as_ref(), &mut path_tag, "aria-errormessage");
        set_attribute(self.aria_expanded.as_ref(), &mut path_tag, "aria-expanded");
        set_attribute(self.aria_flowto.as_ref(), &mut path_tag, "aria-flowto");
        set_attribute(self.aria_grabbed.as_ref(), &mut path_tag, "aria-grabbed");
        set_attribute(self.aria_haspopup.as_ref(), &mut path_tag, "aria-haspopup");
        set_attribute(self.aria_hidden.as_ref(), &mut path_tag, "aria-hidden");
        set_attribute(self.aria_invalid.as_ref(), &mut path_tag, "aria-invalid");
        set_attribute(self.aria_keyshortcuts.as_ref(), &mut path_tag, "aria-keyshortcuts");
        set_attribute(self.aria_label.as_ref(), &mut path_tag, "aria-label");
        set_attribute(self.aria_labelledby.as_ref(), &mut path_tag, "aria-labelledby");
        set_attribute(self.aria_level.as_ref(), &mut path_tag, "aria-level");
        set_attribute(self.aria_live.as_ref(), &mut path_tag, "aria-live");
        set_attribute(self.aria_modal.as_ref(), &mut path_tag, "aria-modal");
        set_attribute(self.aria_multiline.as_ref(), &mut path_tag, "aria-multiline");
        set_attribute(self.aria_multiselectable.as_ref(), &mut path_tag, "aria-multiselectable");
        set_attribute(self.aria_orientation.as_ref(), &mut path_tag, "aria-orientation");
        set_attribute(self.aria_owns.as_ref(), &mut path_tag,"aria-owns");
        set_attribute(self.aria_placeholder.as_ref(), &mut path_tag, "aria-placeholder");
        set_attribute(self.aria_posinset.as_ref(), &mut path_tag, "aria-posinset");
        set_attribute(self.aria_pressed.as_ref(), &mut path_tag, "aria-pressed");
        set_attribute(self.aria_readonly.as_ref(), &mut path_tag, "aria-readonly");
        set_attribute(self.aria_relevant.as_ref(), &mut path_tag, "aria-relevant");
        set_attribute(self.aria_required.as_ref(), &mut path_tag, "aria-required");
        set_attribute(self.aria_roledescription.as_ref(), &mut path_tag, "aria-roledescription");
        set_attribute(self.aria_rowcount.as_ref(), &mut path_tag, "aria-rowcount");
        set_attribute(self.aria_rowindex.as_ref(), &mut path_tag, "aria-rowindex");
        set_attribute(self.aria_rowspan.as_ref(), &mut path_tag, "aria-rowspan");
        set_attribute(self.aria_selected.as_ref(), &mut path_tag, "aria-selected");
        set_attribute(self.aria_setsize.as_ref(), &mut path_tag, "aria-setsize");
        set_attribute(self.aria_sort.as_ref(), &mut path_tag, "aria-sort");
        set_attribute(self.aria_valuemax.as_ref(), &mut path_tag, "aria-valuemax");
        set_attribute(self.aria_valuemin.as_ref(), &mut path_tag, "aria-valuemin");
        set_attribute(self.aria_valuenow.as_ref(), &mut path_tag, "aria-valuenow");
        set_attribute(self.aria_valuetext.as_ref(), &mut path_tag, "aria-valuetext");
        set_attribute(self.role.as_ref(), &mut path_tag, "role");
